...
class Carinfo(models.Model):
    ...
    regist_date = models.DateField(null=False,verbose_name='上牌时间')
    ...
    maintenance_record = models.CharField(choices=FOR_CHOICE,default='false',max_length=10,verbose_name='维修记录')
    price = models.DecimalField(max_digits=8,decimal_places=2,verbose_name='期望售价')
    extractprice = models.DecimalField(max_digits=8,decimal_places=2,verbose_name='成交售价')
    ...
    formalities = models.CharField(choices=FOR_CHOICE,default='true',max_length=10,verbose_name='手续')
    debt = models.CharField(choices=FOR_CHOICE,default='false',max_length=10,verbose_name='债务')
